...
use crate::sys::{k_sleep, k_ticks_t, k_timeout_t};
...
pub const FOREVER: k_timeout_t = k_timeout_t { ticks: -1 as k_ticks_t };
pub const NO_WAIT: k_timeout_t = k_timeout_t { ticks: 0 };
